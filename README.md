...
![article-end.png](./images/article-end.png)
...
Тема Yuminos подразумевает использование цветовой схемы `gruvbox` для блоков кода. Цвета кнопки копирования взяты из её палитры. Тема содержит встроенные стили для блоков кода ([highlight-style.css](./static/css/highlight-style.css)), основанные на теме `gruvbox`. Размер табуляции равен 4 пробелам.
...
<summary>Исходный код (.md)</summary>
...
![codeblock-title-md.png](./images/codeblock-title-md.png)
...
![codeblock-title.png](./images/codeblock-title.png)
